...
module.exports = {
                ...
                fetch(mockApiEndpoint)
                    ...
                    .then(tableData => {
                        ...
                        if (found) {
                            ...
                            // if (data.metaInfo.taskName === 'AnythingElse' && data.metaInfo.state === 'inProgress') {
                            //     // Discard the 'AnythingElse' task and redirect to the task specified in data.triggerDialog
                            //     data.metaInfo.taskName = data.triggerDialog;
                            //     data.metaInfo.state = 'inProgress';
                            // } else {
                            //     // Set the triggerDialog dynamically based on the intent name
                            //     data.triggerDialog = intentData.IntentName;
                            // }
    ...
    on_bot_message: function (requestId, data, callback) {
        ...
        if (data.context.intentName === "AnythingElse") {
            anythingelse = true;
            // if (data.message == "Yes, Your input 'pay my bill' is Eligible" && anythingelse == true){
            //     data.triggerDialog = 'paybill'
            // }
        } else {
